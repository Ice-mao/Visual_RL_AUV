...
class Workspace:
    ...
    def setup(self):
        ...
        # create envs
        self.train_env = ae.make(self.cfg.task_name, self.cfg.frame_stack,
                                  self.cfg.action_repeat, self.cfg.seed, self.cfg.config_name)
        self.eval_env = ae.make(self.cfg.task_name, self.cfg.frame_stack,
                                 self.cfg.action_repeat, self.cfg.seed, self.cfg.config_name)
...
def main(cfgs):
    from train_auv import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfgs)
